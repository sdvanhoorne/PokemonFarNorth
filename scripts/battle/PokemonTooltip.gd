...
#func _on_sprite_area_mouse_entered() -> void:
	...
	#container.get_node("Attack").text = "Attack: %d" % pokemon.stats.attack
	#container.get_node("Defense").text = "Defense: %d" % pokemon.stats.defense
	#container.get_node("SpecialAttack").text = "SpecialAttack: %d" % pokemon.stats.special_attack
	#container.get_node("SpecialDefense").text = "SpecialDefense: %d" % pokemon.stats.special_defense
	#container.get_node("Speed").text = "Speed: %d" % pokemon.stats.speed
